...
class OnTimeForExam
{
    static void Main()
    {
        ...
        var examTime = examHours * 60 + examMinutes; // hrs to min + min == hours in minutes!
        var studentTime = studentHours * 60 + studentMinutes;//same here
        var minutesDifference = studentTime - examTime; // difference


        Console.WriteLine(examTime);
        Console.WriteLine(studentTime);
